...
<head>
    ...
    <title>Search for groom by name</title>
...
<body>
    ...
    <section class="section">
        ...
        <h1 class="text-center">Search profile By Age</h1>
        <div class="container-fluid form-container">
            ...
            <form action="search_age_groom_back.php" method="POST">


                  <div class="input-group">
                      <input type="" class="form-control" name="search" placeholder="Enter your prefered Age">
                  </div>
                  <center>
