...
<?php
	...
	if (isset($_POST['submit'])) {
		...
		$query="SELECT uid,name,dob,state,district,post,email,phone,age,religion,caste,address FROM datas WHERE religion= '$searchkey1' AND gender='female' AND caste= '$searchkey2'";
