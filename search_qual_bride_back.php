...
<?php
	...
	if (isset($_POST['submit'])) {
		$searchkey=$_POST['Qualification'];
        

		$query="SELECT uid,name,dob,state,district,post,email,phone,age,religion,caste,address,edu FROM datas WHERE edu= '$searchkey' AND gender='female' ";
