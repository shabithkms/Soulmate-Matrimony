...
<section class="section">	<div class="container">
				...
				<div class="row">
                    <?php
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $query="SELECT uid,name,dob,state,district,post,email,phone FROM datas WHERE name LIKE '$searchkey%' AND gender='female' ";
                        }else{
	...
	<center>
        <a href="view.php" style="text-decoration: none;">
           <input type="submit" name="submit" value="View Profile" class="btn" style="width: 140px;">
           </a> </center>
		   </section>
</body>
</html>