...
<head>
    ...
    <title>Search for groom by Qualification</title>
...
<body>
    ...
    <section class="section">
        ...
        <h1 class="text-center">Search profile By Qualification</h1>
        <div class="container-fluid form-container">
            ...
            <form action="search_qual_bride_back.php" method="POST">
